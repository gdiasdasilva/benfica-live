    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        <form action="/admin/spots/submissions/{{ $spot->id }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="formSpotCountry" class="form-control" name="country_id" required>
                                        ...
                                        @foreach ($countries_list as $country)
                                            <option value="{{ $country->id }}" @if($country->id == $spot->country_id) selected @endif>
                                                {{ $country->name_pt }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="latitudeLongitude" placeholder="latitude,longitude" name="latitudeLongitude" required value="{{ $spot->latitude }},{{ $spot->longitude }}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
